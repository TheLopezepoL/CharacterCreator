...
public abstract class aPersonaje {
    ...
    public abstract int atacar();   // Ver como hacer que el arma ataque segun la posicion del personaje
    public abstract void seleccionarArma(aArma arma);
    public abstract boolean canMove(ArrayList<Integer> newPosition, Mapa mapa); // Puede recibir el obstaculo y no el mapa (trabajo del controlador)
